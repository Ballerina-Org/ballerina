import { DispatcherContext, DispatchPrimitiveType, Template, ValueOrErrors } from "../../../../../../../main";
    ...
    >(
      ...
      renderer.kind != "lookupRenderer"
        ? ValueOrErrors.Default.throwOne(
            `expected renderer.kind == "lookupRenderer" but got ${renderer.kind}`,
          )
        : dispatcherContext
            .getConcreteRendererKind(renderer.name)
            .Then((viewKind) =>
