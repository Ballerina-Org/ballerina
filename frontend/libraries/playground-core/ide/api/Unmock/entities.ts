import {EntityApis, Guid, PromiseRepo, unit} from "ballerina-core";
import {v4} from "uuid";
...
export const IdeEntityApis: EntityApis = {
    ...
    get: (apiName: string) => {
        ...
        return async (id: Guid) => {
         
            const t = await getSeed(LocalStorage_SpecName.get()!, apiName);
