    ...
    streamingTable:
      ...
      (props) => {
        const currentSortColumn =
          props.context.customFormState.streamParams.value.get("sortColumn");
        const currentSortDirection =
          props.context.customFormState.streamParams.value.get("sortDirection");
                          ...
                          {currentSortColumn == header &&
                            {
                              ...
                              desc: " (⬆)",
                              none: "",
                            }[(currentSortDirection ?? "none") as string]}
                        </button>
                      </th>
                    ))}
                  </tr>
