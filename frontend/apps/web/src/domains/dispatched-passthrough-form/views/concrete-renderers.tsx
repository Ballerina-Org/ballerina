...
export type PersonConcreteRenderers = {
  one: {
    admin: OneAbstractRendererView;
    partialAdmin: OneAbstractRendererView;
    bestFriend: OneAbstractRendererView;
  };
  record: {
    personDetails: RecordAbstractRendererView;
    userDetails: RecordAbstractRendererView;
    friendsDetails: RecordAbstractRendererView;
    preview: RecordAbstractRendererView;
    address: RecordAbstractRendererView;
  };
  union: {
    personCases: UnionAbstractRendererView;
    job: UnionAbstractRendererView;
  };
  table: {
    table: AbstractTableRendererView;
    finiteTable: AbstractTableRendererView;
    streamingTable: AbstractTableRendererView;
  };
  injectedCategory: {
    defaultCategory: CategoryAbstractRendererView;
  };
  boolean: {
    defaultBoolean: BoolAbstractRendererView;
    secondBoolean: BoolAbstractRendererView;
  };
  number: {
    defaultNumber: NumberAbstractRendererView;
  };
  string: {
    defaultString: StringAbstractRendererView;
  };
  date: {
    defaultDate: DateAbstractRendererView;
  };
  enumSingleSelection: {
    defaultEnum: EnumAbstractRendererView;
  };
  enumMultiSelection: {
    defaultEnumMultiselect: EnumMultiselectAbstractRendererView;
  };
  streamSingleSelection: {
    defaultInfiniteStream: SearchableInfiniteStreamAbstractRendererView;
  };
  streamMultiSelection: {
    defaultInfiniteStreamMultiselect: InfiniteStreamMultiselectAbstractRendererView;
  };
  list: {
    defaultList: ListAbstractRendererView;
  };
  map: {
    defaultMap: MapAbstractRendererView;
  };
  sum: {
    defaultSum: SumAbstractRendererView;
    alwaysRight: SumAbstractRendererView;
    maybeDate: SumAbstractRendererView;
  };
  sumUnitDate: {
    maybeDate: SumAbstractRendererView;
  };
  unit: {
    defaultUnit: UnitAbstractRendererView;
  };
  base64File: {
    defaultBase64File: Base64FileAbstractRendererView;
  };
  secret: {
    defaultSecret: SecretAbstractRendererView;
  };
  tuple: {
    defaultTuple2: TupleAbstractRendererView;
    defaultTuple3: TupleAbstractRendererView;
  };
};

export const PersonConcreteRenderers: PersonConcreteRenderers = {
  one: {
    admin: (props) => {
