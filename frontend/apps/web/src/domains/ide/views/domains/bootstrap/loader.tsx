...
import {BaseViewerPredictionAnimationOverlay} from "@blp-private-npm/ui";
type LoaderProps = BootstrapPhase;
import * as animation from "./animation.json";
import * as ballerina from "./ballerina.json"
export const Bootstrap = (props: LoaderProps) : React.ReactElement => {
    return props.kind == "initializing" ? <div className="w-screen h-screen flex items-center justify-center">
        <div className="relative w-120  mx-auto">
            {/*<BaseViewerPredictionAnimationOverlay json={animation} />*/}
