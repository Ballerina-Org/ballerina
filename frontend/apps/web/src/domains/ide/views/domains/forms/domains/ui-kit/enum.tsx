...
export const EnumFieldViewsMultiSelection = {
  enumMultiselect: () => (props) => {
    return <EnumMultiselectWithContextMenuComponent {...props} />;
  },
  enumMultiselectWithMenuContext: () => (props) => {
    return <EnumMultiselectWithContextMenuComponent {...props} />;
  },
  enumMultiselectWithLabel: () => (props) => {
    const ddTranslationsWithCtx = translateForDataDrivenTranslationsWithContext(
      props.context.extraContext.locale,
      props.context.extraContext.namespace
    );
    ...
    return (
      ...
      >
        <EnumMultiselectComponent {...props} />
      </BaseLabelV3>
    );
  },
  enumMultiselectCell: () => (props) => {
    return (
      <EnumMultiselectComponent
        {...props}
        context={{
...
} satisfies IdeConcreteRenderers["enumMultiSelection"];
