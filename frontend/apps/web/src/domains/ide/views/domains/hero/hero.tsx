...
import {BasicFun, SimpleCallback, Unit} from "ballerina-core";
import {HeroPhaseView} from "playground-core";

export const Hero: HeroPhaseView = (props) => {
            ...
            <div className="ml-12">
                ...
                <div className="w-full flex flex-col gap-4">
                    ...
                    <div className="flex flex-col lg:flex-row gap-4">
                            ...
                            <div className="card-body">
                                ...
                                <div className="card-actions justify-end">
                                    <button 
                                        ...
                                        onClick={() => props.foreignMutations.onSelect1() }>select</button>
                                </div>
                            </div>
                        </div>
                        ...
                        {/*        <p>Define and evaluate free key values</p>*/}
                        {/*        <div className="card-actions justify-end">*/}
                        {/*            <button className="btn btn-primary" */}
                        {/*                    onClick={() => props.foreignMutations.onSelect3() }>select</button>*/}
                        {/*        </div>*/}
                        {/*    </div>*/}
                        {/*</div>*/}
                    </div>
