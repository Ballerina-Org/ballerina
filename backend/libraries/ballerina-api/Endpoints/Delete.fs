...
module Delete =
  ...
  let delete<'runtimeContext, 'db, 'customExtension, 'tenantId, 'schemaName
    ...
    app.MapPost(
      ...
      Func<'tenantId, 'schemaName, bool, DeletePayload, IResult>(fun tenantId schemaName draft payload ->
    ...
    app.MapPost(
      ...
      Func<'tenantId, 'schemaName, bool, DeleteManyPayload, IResult>(fun tenantId schemaName draft payload ->
        let result =
          sum {
