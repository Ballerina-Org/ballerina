...
module Primitives =
  ...
  let toJsonPrimitivesValue
    ...
    fun _toJsonRootExpr _toJsonRootValue _toJsonExprTail toJsonValueTail value ->
      sum {
        match value with
        | ConstInt i ->
  ...
  let toJsonPrimitivesExpr
    : (Expr<'ExprExtension, 'ValueExtension> -> Sum<JsonValue, Errors>)
        ...
        -> PrimitivesExprExtension<'ExprExtension, 'ValueExtension, 'ExprExtensionTail, 'ValueExtensionTail>
        -> Sum<JsonValue, Errors> =
    fun toJsonRootExpr _toJsonRootValue toJsonExprTail _toJsonValueTail expr ->
      sum {
        match expr with
        | Binary(op, l, r) ->
  ...
  let typeCheckExprPrimitives
    ...
    fun _ctx typeCheckTail typeCheckRootExpr typeCheckRootValue typeBindings vars e ->
      ...
      let typeCheckBinaryOperator
        ...
        sum {
          ...
          | Plus ->
            ...
            match t1, t2 with
            | PrimitiveType IntType, PrimitiveType IntType -> PrimitiveType IntType
            | _ ->
              return!
                sum.Throw(
      ...
      sum {
        ...
        | PrimitivesExprExtension.Rest t ->
          return! typeCheckTail typeCheckRootExpr typeCheckRootValue typeBindings vars t
      }
  ...
  let typeCheckValuePrimitives
    ...
    fun _ctx typeCheckTail _typeCheckRootExpr _typeCheckRootValue typeBindings vars v ->
