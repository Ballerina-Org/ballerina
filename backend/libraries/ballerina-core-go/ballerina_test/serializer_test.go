...
func TestSumSerialization(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "left", sum: ballerina.Left[ballerina.Unit, ballerina.Unit](ballerina.Unit{}), expected: json.RawMessage(`{"discriminator":"sum","value":[0,2,{"discriminator":"unit"}]}`)},
		{name: "right", sum: ballerina.Right[ballerina.Unit, ballerina.Unit](ballerina.Unit{}), expected: json.RawMessage(`{"discriminator":"sum","value":[1,2,{"discriminator":"unit"}]}`)},
	}
...
func TestSumDeserialization(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "left", serialized: json.RawMessage(`{"discriminator":"sum","value":[0,2,{"discriminator":"unit"}]}`), expected: ballerina.Left[ballerina.Unit, ballerina.Unit](ballerina.Unit{})},
		{name: "right", serialized: json.RawMessage(`{"discriminator":"sum","value":[1,2,{"discriminator":"unit"}]}`), expected: ballerina.Right[ballerina.Unit, ballerina.Unit](ballerina.Unit{})},
	}
...
func TestSumDeserializationError(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "on-sum-on-left", serialized: json.RawMessage(`{"discriminator":"sum","value":[0,2,{"discriminator":"not-unit"}]}`), expectedError: "on sum: on left: on unit: expected discriminator to be 'unit', got 'not-unit'"},
		{name: "on-sum-on-right", serialized: json.RawMessage(`{"discriminator":"sum","value":[1,2,{"discriminator":"not-unit"}]}`), expectedError: "on sum: on right: on unit: expected discriminator to be 'unit', got 'not-unit'"},
		{name: "not-sum-case", serialized: json.RawMessage(`{"discriminator":"not-sum","value":[0,2,{"discriminator":"unit"}]}`), expectedError: "on sum: expected discriminator to be 'sum', got 'not-sum'"},
		...
		{name: "different-arity", serialized: json.RawMessage(`{"discriminator":"sum","value":[0,3,{"discriminator":"unit"}]}`), expectedError: "on sum: expected arity to be 2, got 3"},
	}
...
func TestOptionSerialization(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "none", option: ballerina.None[ballerina.Unit](), expected: json.RawMessage(`{"discriminator":"sum","value":[0,2,{"discriminator":"unit"}]}`)},
		{name: "some", option: ballerina.Some(ballerina.Unit{}), expected: json.RawMessage(`{"discriminator":"sum","value":[1,2,{"discriminator":"unit"}]}`)},
	}
...
func TestOptionDeserialization(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "none", serialized: json.RawMessage(`{"discriminator":"sum","value":[0,2,{"discriminator":"unit"}]}`), expected: ballerina.None[ballerina.Unit]()},
		{name: "some", serialized: json.RawMessage(`{"discriminator":"sum","value":[1,2,{"discriminator":"unit"}]}`), expected: ballerina.Some(ballerina.Unit{})},
	}
