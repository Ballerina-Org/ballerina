...
module Json =
  ...
  type TypeIdentifier with
    static member FromJson: JsonValue -> Sum<TypeIdentifier, Errors> =
      JsonValue.AssertKindAndContinueWithField "type-id" "name" (fun nameJson ->
        sum {
  ...
  type Kind with
    static member private FromJsonSymbol: JsonValue -> Sum<Kind, Errors> =
      JsonValue.AssertKindAndContinue "symbol" (fun _ -> sum { return Kind.Symbol })

    static member private FromJsonStar: JsonValue -> Sum<Kind, Errors> =
      JsonValue.AssertKindAndContinue "star" (fun _ -> sum { return Kind.Star })

    static member private FromJsonArrow: JsonValue -> Sum<Kind, Errors> =
      JsonValue.AssertKindAndContinueWithField "arrow" "arrow" (fun arrowFields ->
        sum {
  ...
  type PrimitiveType with
    ...
    static member private FromJsonUnit: JsonValue -> Sum<PrimitiveType, Errors> =
      JsonValue.AssertKindAndContinue "unit" (fun _ -> sum { return PrimitiveType.Unit })

    static member private FromJsonGuid: JsonValue -> Sum<PrimitiveType, Errors> =
      JsonValue.AssertKindAndContinue "guid" (fun _ -> sum { return PrimitiveType.Guid })

    static member private FromJsonInt: JsonValue -> Sum<PrimitiveType, Errors> =
      JsonValue.AssertKindAndContinue "int" (fun _ -> sum { return PrimitiveType.Int })

    static member private FromJsonDecimal: JsonValue -> Sum<PrimitiveType, Errors> =
      JsonValue.AssertKindAndContinue "decimal" (fun _ -> sum { return PrimitiveType.Decimal })

    static member private FromJsonString: JsonValue -> Sum<PrimitiveType, Errors> =
      JsonValue.AssertKindAndContinue "string" (fun _ -> sum { return PrimitiveType.String })

    static member private FromJsonBool: JsonValue -> Sum<PrimitiveType, Errors> =
      JsonValue.AssertKindAndContinue "bool" (fun _ -> sum { return PrimitiveType.Bool })

    static member private FromJsonDateTime: JsonValue -> Sum<PrimitiveType, Errors> =
      JsonValue.AssertKindAndContinue "datetime" (fun _ -> sum { return PrimitiveType.DateTime })

    static member private FromJsonDateOnly: JsonValue -> Sum<PrimitiveType, Errors> =
      JsonValue.AssertKindAndContinue "dateonly" (fun _ -> sum { return PrimitiveType.DateOnly })
  ...
  type TypeValue with
    ...
    static member private FromJsonVar: JsonValue -> Sum<TypeValue, Errors> =
      JsonValue.AssertKindAndContinueWithField "var" "var" (TypeVar.FromJson >> sum.Map TypeValue.Var)

    static member FromJsonLookup: JsonValue -> Sum<TypeValue, Errors> =
      JsonValue.AssertKindAndContinueWithField "lookup" "lookup" (fun lookupFields ->
        sum {
    ...
    static member FromJsonLambda: JsonValue -> Sum<TypeValue, Errors> =
      JsonValue.AssertKindAndContinueWithField "lambda" "lambda" (fun lambdaFields ->
        sum {
    ...
    static member FromJsonRecord: JsonValue -> Sum<TypeValue, Errors> =
      JsonValue.AssertKindAndContinueWithField "record" "record" (fun recordFields ->
        sum {
    ...
    static member FromJsonTuple: JsonValue -> Sum<TypeValue, Errors> =
      JsonValue.AssertKindAndContinueWithField "tuple" "tuple" (fun tupleFields ->
        sum {
    ...
    static member FromJsonUnion: JsonValue -> Sum<TypeValue, Errors> =
      JsonValue.AssertKindAndContinueWithField "union" "union" (fun unionFields ->
        sum {
    ...
    static member FromJsonSum: JsonValue -> Sum<TypeValue, Errors> =
      JsonValue.AssertKindAndContinueWithField "sum" "sum" (fun sumFields ->
        sum {
    ...
    static member FromJsonList: JsonValue -> Sum<TypeValue, Errors> =
      JsonValue.AssertKindAndContinueWithField "list" "list" (fun elementType ->
        sum {
    ...
    static member FromJsonSet: JsonValue -> Sum<TypeValue, Errors> =
      JsonValue.AssertKindAndContinueWithField "set" "set" (fun elementType ->
        sum {
          let! elementType = elementType |> TypeValue.FromJson
    ...
    static member FromJsonMap: JsonValue -> Sum<TypeValue, Errors> =
      JsonValue.AssertKindAndContinueWithField "map" "map" (fun mapFields ->
        sum {
  ...
  and TypeExpr with
    static member private FromJsonApply: JsonValue -> Sum<TypeExpr, Errors> =
      JsonValue.AssertKindAndContinueWithField "apply" "apply" (fun applyFields ->
        sum {
    ...
    static member FromJsonLookup: JsonValue -> Sum<TypeExpr, Errors> =
      JsonValue.AssertKindAndContinueWithField
        "lookup"
        "lookup"
        (JsonValue.AsString >>= (TypeExpr.Lookup >> sum.Return))
    ...
    static member FromJsonList: JsonValue -> Sum<TypeExpr, Errors> =
      JsonValue.AssertKindAndContinueWithField "list" "list" (TypeExpr.FromJson >>= (TypeExpr.List >> sum.Return))

    static member FromJsonSet: JsonValue -> Sum<TypeExpr, Errors> =
      JsonValue.AssertKindAndContinueWithField "set" "set" (TypeExpr.FromJson >>= (TypeExpr.Set >> sum.Return))
    ...
    static member FromJsonKeyOf: JsonValue -> Sum<TypeExpr, Errors> =
      JsonValue.AssertKindAndContinueWithField "keyOf" "keyOf" (TypeExpr.FromJson >>= (TypeExpr.KeyOf >> sum.Return))

    static member FromJsonFlatten: JsonValue -> Sum<TypeExpr, Errors> =
      JsonValue.AssertKindAndContinueWithField "flatten" "flatten" (fun flattenFields ->
        sum {
    ...
    static member FromJsonExclude: JsonValue -> Sum<TypeExpr, Errors> =
      JsonValue.AssertKindAndContinueWithField "exclude" "exclude" (fun excludeFields ->
        sum {
    ...
    static member FromJsonRotate: JsonValue -> Sum<TypeExpr, Errors> =
      JsonValue.AssertKindAndContinueWithField "rotate" "rotate" (TypeExpr.FromJson >>= (TypeExpr.Rotate >> sum.Return))
