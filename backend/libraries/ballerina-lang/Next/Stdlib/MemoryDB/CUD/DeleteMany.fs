                  ...
                  |> Map.map (fun _entityId _unit ->
                    reader {
                      ...
                      | Some currentValueWithProps ->
                        ...
                        do! onDeletingHook _entity _schema_as_value.Value.Value loc0 _entityId currentValueWithProps

                        do removeEntityValue _db _entity _entityId

                        do! onDeletedHook _entity _schema_as_value.Value.Value loc0 _entityId currentValueWithProps
