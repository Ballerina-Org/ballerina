...
def test_tuple_3_roundtrip() -> None:
    value = (1, 2, 3)
    serializer = tuple_3_to_json(int32_to_json, int32_to_json, int32_to_json)
    parser = tuple_3_from_json(int32_from_json, int32_from_json, int32_from_json)
    assert parser(serializer(value)) == Sum.right(value)


def test_tuple_4_roundtrip() -> None:
    value = (1, 2, 3, 4)
    serializer = tuple_4_to_json(int32_to_json, int32_to_json, int32_to_json, int32_to_json)
    parser = tuple_4_from_json(int32_from_json, int32_from_json, int32_from_json, int32_from_json)
    assert parser(serializer(value)) == Sum.right(value)


def test_tuple_5_roundtrip() -> None:
    value = (1, 2, 3, 4, 5)
    serializer = tuple_5_to_json(int32_to_json, int32_to_json, int32_to_json, int32_to_json, int32_to_json)
    parser = tuple_5_from_json(int32_from_json, int32_from_json, int32_from_json, int32_from_json, int32_from_json)
    assert parser(serializer(value)) == Sum.right(value)


def test_tuple_6_roundtrip() -> None:
    value = (1, 2, 3, 4, 5, 6)
    serializer = tuple_6_to_json(
        int32_to_json, int32_to_json, int32_to_json, int32_to_json, int32_to_json, int32_to_json
    )
    parser = tuple_6_from_json(
        int32_from_json, int32_from_json, int32_from_json, int32_from_json, int32_from_json, int32_from_json
    )
    assert parser(serializer(value)) == Sum.right(value)
...
def test_tuple_7_roundtrip() -> None:
    ...
    serializer = tuple_7_to_json(
        int32_to_json, int32_to_json, int32_to_json, int32_to_json, int32_to_json, int32_to_json, int32_to_json
    )
...
def test_tuple_3_error_context_on_second_element() -> None:
    serialized: Json = {
        ...
        VALUE_KEY: [int32_to_json(1), {DISCRIMINATOR_KEY: "int32", VALUE_KEY: 123}, int32_to_json(3)],
    }
    parser = tuple_3_from_json(int32_from_json, int32_from_json, int32_from_json)
