...
def test_list_to_json() -> None:
    ...
    assert serialized == {"discriminator": "list", "value": [int32_to_json(1), int32_to_json(2), int32_to_json(3)]}


def test_list_from_json() -> None:
    serialized: Json = {"discriminator": "list", "value": [int32_to_json(1), int32_to_json(2), int32_to_json(3)]}
