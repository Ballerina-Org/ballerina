...
class TestComplexTypesSerializer:
    ...
    def test_should_serialize_list_of_tuples_of_int_and_option_string() -> None:
        ...
        serialized = serializer(value)
        assert serialized == [{"Item0": 42, "Item1": {"discriminator": "some", "value": "hello"}}, {"Item0": 43, "Item1": {"discriminator": "nothing", "value": None}}]

    @staticmethod
    def test_should_deserialize_list_of_tuples_of_int_and_option_string() -> None:
        serialized: Json = [{"Item0": 42, "Item1": {"discriminator": "some", "value": "hello"}}, {"Item0": 43, "Item1": {"discriminator": "nothing", "value": None}}]
    ...
    def test_should_serialize_record_of_sum_of_string_and_option_float_when_str_is_set() -> None:
        ...
        serializer = dict_serializer(str_serializer, sum_serializer(str_serializer, option_serializer(float_serializer)))
        serialized = serializer(value)
    ...
    def test_should_deserialize_record_of_sum_of_string_and_option_float_when_str_is_set() -> None:
        ...
        deserializer = dict_deserializer(str_deserializer, sum_deserializer(str_deserializer, option_deserializer(float_deserializer)))
        value = deserializer(serialized)
