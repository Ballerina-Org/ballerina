...
type TypeValue<'valueExt> with
  ...
  static member PrimitiveWithTrivialSource
    (v: PrimitiveType)
    : TypeValue<'valueExt> =
    match v with
    | PrimitiveType.Unit ->
    ...
    | PrimitiveType.Guid ->
      TypeValue.Primitive
        { value = v
          typeExprSource =
            TypeExprSourceMapping.OriginTypeExpr(
              TypeExpr.Primitive PrimitiveType.Guid
            )
          typeCheckScopeSource = TypeCheckScope.Empty }
    | PrimitiveType.Int32 ->
      TypeValue.Primitive
    ...
    | PrimitiveType.TimeSpan ->
      TypeValue.Primitive
        { value = v
          typeExprSource =
            TypeExprSourceMapping.OriginTypeExpr(
              TypeExpr.Primitive PrimitiveType.TimeSpan
            )
          typeCheckScopeSource = TypeCheckScope.Empty }
    | PrimitiveType.Vector ->
      TypeValue.Primitive
        { value = v
          typeExprSource =
            TypeExprSourceMapping.OriginTypeExpr(
              TypeExpr.Primitive PrimitiveType.Vector
            )
          typeCheckScopeSource = TypeCheckScope.Empty }
